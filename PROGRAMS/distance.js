...
// integer >= 0), k(number of towns to visit, k >= 1) and ls(list of distances, all distances are positive or null integers and this list has at least one element).The

// function returns the "best"
// sum ie the biggest possible sum of k distances less than
// or equal to the given limit t,
// if that sum exists, or otherwise
// return null.
// Examples:
